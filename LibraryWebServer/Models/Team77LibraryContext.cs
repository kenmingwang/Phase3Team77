...
{
    public partial class Team77LibraryContext : DbContext
    {
        public Team77LibraryContext()
        {
        }

        public Team77LibraryContext(DbContextOptions<Team77LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1193853;Password=pwd;Database=Team77Library");
            }
        }
